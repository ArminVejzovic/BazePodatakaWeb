...
sql
	...
	/* Ova tabela vozila_dostavljaci se ne koristi da znas
	...
	*/
	...
	alter table narudzbe
	drop column ime_narucioca,
	drop column prezime_narucioca,
	drop column adresa_narucioca,
	drop column grad_narucioca,
	drop column kontakt_telefon_narudzbe;
	...
	begin
	    ...
	    -- Provjera da li je dostavljač razdužen na svim mestima
	    select count(*)
		...
		-- Provjera da li je vozilo razduženo na svim mestima
		select count(*)
		into vozilo_razduzeno
		from zaduzenja_vozila
